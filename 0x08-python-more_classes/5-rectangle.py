#!/usr/bin/python3
"""
This script, 5-rectangle, is created for Holberton Python project 0x08 task 5.
"""
...
class Rectangle:
    ...
    __str__, __repr__, and __del__ functionality are defined below.
    ...
    Methods:
        ...
        __del__(self): Prints a message upon the deletion of an instance.
    ...
    def __del__(self):
        """Prints a message upon the deletion of an instance."""
        print('Bye rectangle...')
